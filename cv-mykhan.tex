...
\newcommand{\qone}{\colorbox{YellowGreen}{\makebox(10,9){\textcolor{white}{\ Q1}}}}
\newcommand{\qtwo}{\colorbox{Gold}{\makebox(10,9){\textcolor{white}{\ Q2}}}}
\newcommand{\qthree}{\colorbox{DarkOrange}{\makebox(10,9){\textcolor{white}{Q3}}}}
\newcommand{\qfour}{\colorbox{Tomato}{\makebox(10,9){\textcolor{white}{\ Q4}}}}
...
\begin{enumerate}
\itemsep-4pt
\item {\it Member}, Technical committee, 1st Mohammad Ali Jinnah University Intl. Conf. on Computing, MAJU, Karachi (2021)
\item {\it Member}, Organising committee, 1st Intl. Conf. on Data Sciences, MAJU, Karachi (2019)
\item {\it Trainer}, 1-Day Workshop on Data Science with Python, UBIT, Karachi University (2018)
\item {\it Trainer}, Hands-on Programming with Python, MAJU, Karachi (2018)
\item {\it Trainer}, Programming with Python, Combat:18, KIET, Karachi (2018)
\item {\it Coach}, ICPC 2015 @ NUCES-FAST, Lahore (2015)
\item {\it Faculty head}, CodeJam, PAF-KIET, Karachi (2015)
\item {\it Faculty head}, Combat: The Computing Battle 2017, KIET, Karachi (2014)
\item {\it Coach}, Startup-Weekend, IBA, Karachi (2012)
\end{enumerate}
