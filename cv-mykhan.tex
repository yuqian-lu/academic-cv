...
URL: \href{https://scholar.google.com/citations?user=a_d2KTEAAAAJ&hl=en}{Google Scholar} $\cdot$ \href{https://www.researchgate.net/profile/Muhammad_Yaseen_Khan}{ResearchGate}
\end{minipage}
...
Mohammad Ali Jinnah University, Karachi, 2018--cont'd. Advisor: Tafseer A. Khan\\
Karachi Institute of Economics \& Technology, 2014--2015. Advisor: Khuram N. Junejo\\
Karachi University, 2007--2010. Advisors: Humera Tariq and S.M. Aquil Burney
\end{minipage}
...
Faculty Member, College of Computing and Information Sciences, Karachi Institute of Economics \& Technology (KIET), Karachi\\
...
\end{minipage}
\begin{minipage}{0.75\textwidth}
CS1420 Object-Oriented Programming; CS6420 Applied Programming\\
CS1410 Computer Programming; CS3110 Software Engineering\\
CS2510 Data Structures and Algorithms; CS6420 Applied Programming; CS6610 Information Retrieval Techniques (co-teach with Shaukat Wasi)\\
...
Artificial Neural Networks/Deep Learning $\cdot$ Natural Language Processing $\cdot$ Information Extraction $\cdot$ Information Retrieval $\cdot$ Cognitive Computing $\cdot$ Affective Computing$\cdot$ Discourse Analysis $\cdot$ Computational Linguistics $\cdot$ Supervised and Unsupervised Learning $\cdot$ Sociolinguistics $\cdot$ NLP for scared source Indic languages (specifically languages in Perso-Arabic scripts) $\cdot$ Emotion Detection and Sentiment Analysis in Text.
